...
class Rigtk_test(Main, Rigtk):
	...
	def test_resetPivotTransforms(self):
		...
		'''
		self.perform_test({
			"self.resetPivotTransforms('cyl1')": None,
		})
	...
	def test_bakeCustomPivot(self):
		...
		'''
		self.perform_test({
			"self.bakeCustomPivot('cyl1')": None,
			"self.bakeCustomPivot('cyl1', position=True)": None,
			"self.bakeCustomPivot('cyl1', orientation=True)": None,
		})
