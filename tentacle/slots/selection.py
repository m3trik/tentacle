...
class Selection(Slots):
	...
	def __init__(self, *args, **kwargs):
		...
		dh.contextMenu.add(self.sb.ComboBox, setObjectName='cmb006', setToolTip='A list of currently selected objects.')
		...
		dh.contextMenu.add(self.sb.Label, setText='Grow Selection', setObjectName='lbl003', setToolTip='Grow the current selection.')
		dh.contextMenu.add(self.sb.Label, setText='Shrink Selection', setObjectName='lbl004', setToolTip='Shrink the current selection.')
		...
		cmb001.contextMenu.add(self.sb.Label, setText='Select', setObjectName='lbl005', setToolTip='Select the current set elements.')
		cmb001.contextMenu.add(self.sb.Label, setText='New', setObjectName='lbl000', setToolTip='Create a new selection set.')
		cmb001.contextMenu.add(self.sb.Label, setText='Modify', setObjectName='lbl001', setToolTip='Modify the current set by renaming and/or changing the selection.')
		cmb001.contextMenu.add(self.sb.Label, setText='Delete', setObjectName='lbl002', setToolTip='Delete the current set.')
