...
class Mirror(Slots):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.sb.sync_widgets(
            tb000.option_menu.chk000, self.sb.mirror_submenu.chk000, attributes="setChecked"
        )
        self.sb.sync_widgets(
            tb000.option_menu.chk007, self.sb.mirror_submenu.chk007, attributes="setChecked"
        )
        self.sb.sync_widgets(
            tb000.option_menu.chk008, self.sb.mirror_submenu.chk008, attributes="setChecked"
        )
...
#   '''
#   axis = self.sb.get_axis_from_checkboxes('chk000-3', self.sb.mirror.tb000.option_menu)
