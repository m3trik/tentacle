...
class Crease(Slots):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.sb.toggle_widgets(tb000.ctxMenu, setDisabled="s005,s006")
    ...
    def chk002(self, state=None):
        ...
        if self.sb.crease.tb000.ctxMenu.chk002.isChecked():
            ...
            self.sb.toggle_widgets(
                self.sb.crease.tb000.ctxMenu,
                self.crease_submenu.tb000.ctxMenu,
                setChecked="chk002",
                setUnChecked="chk003",
            )
    ...
    def chk011(self, state=None):
        ...
        if self.sb.crease.tb000.ctxMenu.chk011.isChecked():
            self.sb.toggle_widgets(self.sb.crease.tb000.ctxMenu, setEnabled="s005,s006")
        else:
            self.sb.toggle_widgets(self.sb.crease.tb000.ctxMenu, setDisabled="s005,s006")
