...
class Uv(Slots):
	...
	def __init__(self, *args, **kwargs):
		...
		dh.contextMenu.add(self.sb.ComboBox, setObjectName='cmb000', setToolTip='Maya UV Editors')
		...
		tb007.contextMenu.add('QDoubleSpinBox', setPrefix='Texel Density: ', setObjectName='s003', setMinMax_='0.00-128 step1', setValue=5, setToolTip='Set the desired texel density.')
