...
class StatusMixin:
    def insert_scene_status(self, hud) -> None:
        ...
        # Frame rate (effective — see SlotsBlender.effective_fps)
        hud.insertText(
            f'Frame Rate: <font style="color: Yellow;">{round(self.effective_fps(), 2):g} fps</font>'
        )
    ...
    WARNING_DEFS = (
        {
            ...
            "check": lambda self: self.effective_fps() == self._DEFAULT_FPS,
            "describe": lambda self: (
                f'Frame Rate: <font style="color: Orange;">{round(self.effective_fps(), 2):g} fps</font> '
