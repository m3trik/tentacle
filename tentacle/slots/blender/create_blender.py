    ...
    def tb000(self, state=None):
        ...
        if type_ == "Polygon":
            if index == 0:  # cube:
                ...
                node = pm.polySphere(
                    axis=axis, radius=5, subdivisionsX=12, subdivisionsY=12
                )
            elif index == 2:  # cylinder:
                node = pm.polyCylinder(
                    axis=axis,
                    radius=5,
                    height=10,
                    subdivisionsX=12,
                ...
                node = pm.polyPlane(
                    axis=axis, width=5, height=5, subdivisionsX=1, subdivisionsY=1
                )
            elif index == 4:  # circle:
        ...
        # nurbs
            ...
            if index == 0:  # Cube
                node = pm.nurbsCube(
                    ch=1, d=3, hr=1, p=(0, 0, 0), lr=1, w=1, v=1, ax=(0, 1, 0), u=1
                )
            elif index == 1:  # Sphere
                node = pm.sphere(
                    esw=360,
                ...
                node = pm.nurbsPlane(
                    ch=1, d=3, v=1, p=(0, 0, 0), u=1, w=1, ax=(0, 1, 0), lr=1
                )
            elif index == 5:  # Torus
                node = pm.torus(
                    esw=360,
                ...
                node = pm.nurbsSquare(
                    c=(0, 0, 0), ch=1, d=3, sps=1, sl1=1, sl2=1, nr=(0, 1, 0)
                )
