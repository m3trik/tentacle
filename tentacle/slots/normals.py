...
class Normals(Slots):
    ...
    def __init__(self, *args, **kwargs):
        ...
        tb001.ctxMenu.add(
            ...
            setValue=0,
            setToolTip="The normal angle in degrees.",
        )
        tb001.ctxMenu.add(
            "QCheckBox",
            ...
            setChecked=True,
            setToolTip="Soften all non-creased edges.",
        )
        tb001.ctxMenu.add(
            "QCheckBox",
        ...
        tb001.ctxMenu.add(
            ...
            setChecked=True,
            setToolTip="Soften all non-hard edges.",
        )
        tb001.ctxMenu.add(
            "QCheckBox",
        ...
        tb003.ctxMenu.chk002.toggled.connect(
            lambda state, w=tb003.ctxMenu.chk002: w.setText("Lock")
            if state
