...
class Edit(Slots):
    ...
    def __init__(self, *args, **kwargs):
        ...
        dh.ctx_menu.add(self.sb.ComboBox, setObjectName="cmb000", setToolTip="Editors")
        ...
        self.sb.connect_multi("chk006-9", "toggled", self.chk006_9, tb003.option_menu)
        ...
        tb004.option_menu.chk027.toggled.connect(
