...
class Materials(Slots):
	...
	def __init__(self, *args, **kwargs):
		...
		cmb002.contextMenu.add(self.sb.Label, setText='Open in Editor', setObjectName='lbl000', setToolTip='Open material in editor.')
		cmb002.contextMenu.add(self.sb.Label, setText='Rename', setObjectName='lbl001', setToolTip='Rename the current material.')
		cmb002.contextMenu.add(self.sb.Label, setText='Delete', setObjectName='lbl002', setToolTip='Delete the current material.')
		cmb002.contextMenu.add(self.sb.Label, setText='Delete All Unused Materials', setObjectName='lbl003', setToolTip='Delete All unused materials.')
		...
		cmb002.contextMenu.cmb001.currentIndexChanged.connect(lambda: self.sb.materials.group000.setTitle(cmb002.contextMenu.cmb001.currentText())) #set the groupbox title to reflect the current filter.
	...
	def b003(self):
		...
		'''
		self.sb.materials.tb002.contextMenu.chk007.setChecked(True)
	...
	def b004(self):
		...
		'''
		self.sb.materials.tb002.contextMenu.chk008.setChecked(True)
	...
	def b005(self):
		'''Assign: Assign New
		'''
		self.sb.materials.tb002.contextMenu.chk009.setChecked(True)
