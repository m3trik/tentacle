...
class Nurbs(Init):
	...
	def tb000(self, state=None):
		...
		if state is 'setMenu':
			tb.menu_.add('QSpinBox', setPrefix='Degree', setObjectName='s002', setValue=3, setToolTip='The degree of the resulting surface.')
			...
			tb.menu_.add('QSpinBox', setPrefix='Sections', setObjectName='s005', setValue=8, setToolTip='The number of surface spans between consecutive curves in the loft.')
	...
	def tb001(self, state=None):
		...
		if state is 'setMenu':
			...
			tb.menu_.add('QSpinBox', setPrefix='Degree', setObjectName='s000', setValue=3, setToolTip='The degree of the resulting surface.')
			...
			tb.menu_.add('QSpinBox', setPrefix='Section Spans', setObjectName='s001', setValue=1, setToolTip='The number of surface spans between consecutive curves in the loft.')
