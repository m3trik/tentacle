...
class Editors_max(Editors, SlotsMax):
    def __init__(self, *args, **kwargs):
        ...
        l = [
            ...
            "Configure User and System Paths",
            "Hotkey Editor",
            "Plug-in Manager",
            "Preferences",
        ]
    ...
    def tree000(self, wItem=None, column=None):
        ...
        if header == "General Editors":
            if text == "Channel Info":
                ...
                maxEval(
                    'actionMan.executeAction 427416257 "13"'
                )  # Scene Explorer: Open Scene Explorer Default 3
            elif text == "Scene Explorer":
                maxEval(
                    'actionMan.executeAction 427416257 "19"'
                )  # Scene Explorer: Open Scene Explorer Default 9
            elif text == "Property Explorer":
                maxEval(
                    'actionMan.executeAction 427416257 "17"'
                )  # Scene Explorer: Open Scene Explorer Default 7
            elif text == "Container Explorer":
                maxEval('actionMan.executeAction 427416257 "11"')
            elif text == "Max Creation Graph":
                maxEval(
                    'actionMan.executeAction 62682 "44354"'
                )  # Max Creation Graph: New Max Creation Graph
                ...
                maxEval(
                    'actionMan.executeAction 427416257 "16"'
                )  # Scene Explorer: Open Scene Explorer Default 6
                ...
                maxEval(
                    'actionMan.executeAction 0 "40209"'
                )  # File: Configure User Paths
            elif text == "Configure User and System Paths":
                maxEval(
                    'actionMan.executeAction 0 "41001"'
                )  # File: Configure User and System Paths
        ...
        if header == "Animation Editors":
            if text == "Track View: Curve Editor":
                ...
                maxEval(
                    'actionMan.executeAction 0 "40278"'
                )  # Track View: New Track View
        ...
        if header == "Rendering Editors":
            if text == "Render Setup":
                ...
                )  # Render: Rendered Frame Window
            elif text == "State Sets":
                maxEval(
                    'actionMan.executeAction 29771 "33764"'
                )  # State Sets: State Sets...
            elif text == "Camera Sequencer":
                maxEval(
                    'actionMan.executeAction 29771 "57491"'
                )  # State Sets: Camera Sequencer...
            elif text == "Light Tracer":
                maxEval('macros.run "Render" "AdvLighting_LightTracer"')
            elif text == "Light Explorer":
                maxEval(
                    'actionMan.executeAction 427416257 "15"'
                )  # Scene Explorer: Open Scene Explorer Default 5
                ...
                )  # Render: Environment Dialog Toggle
                ...
                maxEval(
                    'actionMan.executeAction 0 "40312"'
                )  # Tools: Material/Map Browser Toggle
            elif text == "Material Explorer":
                maxEval('macros.run "Material Explorer" "MaterialExplorerToggle"')
            elif text == "Video Post":
                maxEval(
                    'actionMan.executeAction 0 "40027"'
                )  # Render: Video Post Dialog Toggle
        ...
        if header == "Relationship Editors":
            if text == "Schematic View":
                ...
                maxEval(
                    'actionMan.executeAction 0 "40429"'
                )  # Schematic View: New Schematic View
    ...
    def showEditor(self, name, width=640, height=480):
        ...
        self.sb.parent().move(
            QtGui.QCursor.pos() - self.sb.parent().rect().center()
