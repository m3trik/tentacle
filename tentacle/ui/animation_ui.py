...
class Ui_QtUi(object):
    def setupUi(self, QtUi):
        ...
        self.tb014 = PushButton(self.keyframes)
        self.tb014.setObjectName(u"tb014")
        self.tb014.setMinimumSize(QSize(0, 20))
        self.tb014.setMaximumSize(QSize(16777215, 20))
        self.tb014.setCheckable(False)

        self.verticalLayout_6.addWidget(self.tb014)
...
#if QT_CONFIG(tooltip)
        self.tb001.setToolTip(QCoreApplication.translate("QtUi", u"<html><head/><body><p>Duplicate any selected keyframes and paste them inverted at the given time.<br/>If none are selected, all keys for the object(s) will be used.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.tb001.setText(QCoreApplication.translate("QtUi", u"Invert Keys", None))
#if QT_CONFIG(tooltip)
        self.tb014.setToolTip(QCoreApplication.translate("QtUi", u"Scale the keys on any selected objects by a given percentage.", None))
#endif // QT_CONFIG(tooltip)
        self.tb014.setText(QCoreApplication.translate("QtUi", u"Scale Keys", None))
#if QT_CONFIG(tooltip)
