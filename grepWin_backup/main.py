...
from radial import Switchboard, EventFactoryFilter, OverlayFactoryFilter, StyleSheet
import radial.ui.widgets as wgts
...
class Main(QtWidgets.QStackedWidget):
	...
	The various ui's are set by calling 'setUi' with the intended ui name string. ex. Main().setUi('polygons')
