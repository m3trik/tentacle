...
| **4. Helper surface** | public names, Blender covers of mayatk | **53%** (946/1779 names); 1 modules absent: render_utils |
...
| GameShader | 4→4 | 4→2 | 8→6 | 2037→664 | 33% | 75% | clean |
...
| ReferenceManager | 2→2 | 36→33 | 4→4 | 3731→1985 | 53% | 100% | clean |
