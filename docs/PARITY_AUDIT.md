...
| **4. Helper surface** | public names, Blender covers of mayatk | **53%** (956/1813 names); 1 modules absent: render_utils |
...
| GameShader | 4→4 | 3→2 | 7→6 | 2044→683 | 33% | 86% | clean |
| MatUpdater | 0→0 | 12→9 | 2→2 | 1165→390 | 33% | 100% | clean |
| SceneExporter | 3→3 | 15→13 | 7→7 | 1381→511 | 37% | 100% | clean |
...
| LightmapBaker | 3→3 | 5→4 | 8→8 | 2308→1602 | 69% | 100% | clean |
